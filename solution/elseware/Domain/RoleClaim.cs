...
/// <summary>
/// Represents a claim associated with a role within the application.
/// </summary>
/// <remarks>
/// It is used to define permissions or attributes that apply to all users assigned to the role.
/// </remarks>
