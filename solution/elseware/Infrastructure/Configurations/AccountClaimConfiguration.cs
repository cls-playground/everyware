...
**** Project:           Elseware
****
**** Module:            AccountClaimConfiguration.cs
****
...
/// <summary>
/// Configures the database schema for the <see cref="AccountClaim"/> entity.
/// </summary>
public class AccountClaimConfiguration : IEntityTypeConfiguration<AccountClaim> {
    ...
    /// <summary>
    /// Configures the <see cref="AccountClaim"/> entity mapping using Fluent API.
    /// </summary>
    /// <param name="p_EntityType">
    /// An <see cref="EntityTypeBuilder{AccountClaim}"/> used to define the entity schema for the <see cref="AccountClaim"/> entity.
    /// </param>
    public void Configure(
        EntityTypeBuilder<AccountClaim> p_EntityType) {

        p_EntityType.ToTable("AccountClaim");
